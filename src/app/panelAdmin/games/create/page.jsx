      ...
      <div className="createGameContainerGrid">
        ...
        <div className="inputsToCreate">
          ...
          <div className="cloudinaryimg2">
            <form
              onSubmit={async (e) => {
                ...
                const API_URL_UPLOAD =
                  process.env.NODE_ENV === "development"
                    ? process.env.NEXT_PUBLIC_URL_REQUESTS_UPLOAD_LOCAL
                    : process.env.NEXT_PUBLIC_URL_REQUESTS_UPLOAD_DEPLOY;
                ...
                if (data.url) {
                  Swal.fire({
                    ...
                    imageUrl:
                      "https://media.giphy.com/media/7YjvlYIMRDcYM/source.gif",
                    imageWidth: 400,
                    imageHeight: 200,
                    imageAlt: "Custom image",
                    background: "#333333",
            ...
            <div className="les2323" onClick={copiarAlPortapapeles}>
              <GrCopy />
            </div>
          </div>
        </div>
