    ...
    set((state) => {
      if (state.gamesInCart.length < 4) {
        ...
        Swal.fire({
          ...
          footer:
            '<a href="http://localhost:3000/cart">Success! The game has been added to your shopping cart.</a>',
        });
        ...
        Swal.fire({
          ...
          footer:
            '<a href="http://localhost:3000/cart">Complete your cart purchase or remove the games.</a>',
