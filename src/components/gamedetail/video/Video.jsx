...
const Video = ({ game, currentImg, setGameEdited, gameEdited }) => {
    ...
    const handleSelectUrl = () => {
        ...
        Swal.fire("the trailer has been changed correctly!");
    ...
    return (
        <div className='videoContainer' >
            ...
            <input type="text" value={url} onChange={handleChange} className={inputClass} />
            <div className='divButtonVideo' onClick={() => handleSelectUrl()}><button disabled={urlError} >INSERT</button></div>
            <div className='trailerInVideo' > <Trailer video={video} /></div>
        </div>
    )
}
